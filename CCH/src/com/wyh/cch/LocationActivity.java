...
import com.wyh.cch.db.DetailForm;
import com.wyh.cch.db.LunchList;
...
public class LocationActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savepoi.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(LocationActivity.this,LunchList.class);
